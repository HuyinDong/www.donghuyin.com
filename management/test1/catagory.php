...
<form action='' method='GET' class='Newsl'><table><tr>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--<input type='hidden' name='id' value='<?=$row2['id']?>'/><input type='text' name='text' value='<?=$row2['name']?>' /><input type='submit' name='Update' value='Update' class="btn btn-success btn-xs"/></td><td><input type='submit' name='Delete' value='Delete' class="btn btn-danger btn-xs"/></td>
     </tr>
